# Focus300 269: LeetCode 210 - Course Schedule II
...
Solve the graph problem 'Course Schedule II' by exploring the reachable structure and returning the required result.
...
def find_order_brute(num_courses, prerequisites):
    ...
    for course, prereq in prerequisites:
        ...
        indegree[course] += 1
    order = [i for i in range(num_courses) if indegree[i] == 0]
